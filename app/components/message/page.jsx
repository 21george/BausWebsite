...
export default function ThanksYouNote() {
  return (
    <div className="card">
      <div className="relative bg-yellow-950 w-[300px] sm:w-[350px] group transition-all duration-700 aspect-video flex items-center justify-center">
