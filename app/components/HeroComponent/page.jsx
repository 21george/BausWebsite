...
const HeroSection = ({
  ...
  return (
    <section className={`w-full ${containerStyles}`}>
      <div className={`w-full h-[700] bg-cover bg-no-repeat bg-center bg-fixed  object-cover flex flex-col justify-center items-center  ${overlayStyles}`} style={{ backgroundImage: `url(${backgroundImage})` }}>
